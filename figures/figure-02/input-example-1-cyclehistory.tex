\begin{tikzpicture}[%
  ...
  \node[lnode,text=black,below=1.0cm of A1,xshift=-2.0cm] (A2) {Met. 2\\2};
  \node[lnode,text=black,below=1.0cm of A1,xshift=+2.0cm] (A3) {Met. 3\\3};
  \node[lnode,text=black,below=1.0cm of A2] (A42) {Met. 4\\4};
  \node[lnode,text=black,below=1.0cm of A3] (A43) {Met. 4\\5};
  \node[lnode,text=black,below=1.0cm of A42,xshift=-1.0cm] (A52) {Met. 5\\6};
  \node[lnode,text=black,below=1.0cm of A42,xshift=+1.0cm] (A62) {Met. 6\\7};
  \node[lnode,text=black,below=1.0cm of A43,xshift=-1.0cm] (A53) {Met. 5\\8};
  \node[lnode,text=black,below=1.0cm of A43,xshift=+1.0cm] (A63) {Met. 6\\9};
  \node[lnode,text=black,below=1.0cm of A52] (A752) {Met. 7\\10};
  \node[lnode,text=black,below=1.0cm of A62] (A762) {Met. 7\\11};
  \node[lnode,text=black,below=1.0cm of A53] (A753) {Met. 7\\12};
  \node[lnode,text=black,below=1.0cm of A63] (A763) {Met. 7\\13};
