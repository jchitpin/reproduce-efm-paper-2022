\begin{tikzpicture}[%
  ...
  \node[lnode,text=black,below=0.5cm of A1] (A2) {Met. 2\\2};
  \node[lnode,text=black,below=0.5cm of A2,xshift=-2.0cm] (A3) {Met. 3\\3};
  \node[lnode,text=black,below=0.5cm of A2,xshift=+2.0cm] (A4) {Met. 4\\4};
  \node[lnode,text=black,below=0.5cm of A3] (A53) {Met. 5\\5};
  \node[lnode,text=black,below=0.5cm of A53,xshift=-1.0cm] (A653) {Met. 6\\7};
  \node[lnode,text=black,below=0.5cm of A53,xshift=+1.0cm] (A753) {Met. 7\\8};
  \node[lnode,text=black,below=0.5cm of A4] (A54) {Met. 5\\6};
  \node[lnode,text=black,below=0.5cm of A54,xshift=-2.0cm] (A34) {Met. 3\\9};
  \node[lnode,text=black,below=0.5cm of A54,xshift=-0.5cm] (A74) {Met. 7\\10};
  \node[lnode,text=black,below=0.5cm of A54,xshift=+1.0cm] (A64) {Met. 6\\11};
